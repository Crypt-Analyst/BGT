    ...
    def handle(self, *args, **options):
        ...
        if not PricingAddon.objects.exists():
            PricingAddon.objects.bulk_create(
                [
                    PricingAddon(
                        name="Domain", price="Ksh 1,500 - 3,000 / year", order=1
                    ),
                    PricingAddon(
                        name="Hosting", price="Ksh 5,000 - 10,000 / year", order=2
                    ),
                    PricingAddon(
                        name="Maintenance", price="Ksh 3,000 - 5,000 / month", order=3
                    ),
            ...
            PortfolioItem.objects.bulk_create(
                [
                    ...
                    PortfolioItem(
                        ...
                        body=(
                            "Delivered a property management presence and systems integration for Ardhi Plus, "
                            "including CRM, listings, and admin workflows."
                        ),
        ...
        terms_defaults = {
            ...
            "body": (
                ...
                "</ul>"
                "<h2>3. Eligibility</h2>"
                "<p>You must be at least 18 years old or have legal authority to enter into "
                "agreements to use our services.</p>"
                ...
                "<p>Clients must maintain clear and timely communication. Delays from the client may "
                "affect delivery timelines.</p>"
                "<h3>6.3 Delivery</h3>"
                ...
                "<p>Upon full payment, ownership of the final product is transferred to the client. "
                "Third-party tools, plugins, or assets remain under their respective licenses.</p>"
                ...
                "<p>While we implement best practices for security, we do not guarantee absolute protection "
                "against cyber threats. Clients are responsible for maintaining their own credentials and backups.</p>"
                "<h2>13. Limitation of Liability</h2>"
                "<p>To the maximum extent permitted by law, Bwire Global Tech shall not be liable for indirect, "
                "incidental, or consequential damages, loss of revenue, data, or business opportunities, or "
                "service interruptions beyond our control.</p>"
                "<h2>14. Indemnification</h2>"
                "<p>You agree to indemnify and hold harmless Bwire Global Tech from any claims, damages, "
                "or liabilities arising from your misuse of our services, content you provide, or violation "
                "of these Terms.</p>"
                ...
                "<p>We reserve the right to update these Terms at any time. Continued use of our services constitutes "
                "acceptance of the updated Terms.</p>"
                "<h2>18. Contact Information</h2>"
                "<p>For any inquiries regarding these Terms:<br>Bwire Global Tech<br>"
                "Email: bwireglobaltech917@gmail.com<br>Phone: 0722206805</p>"
            ),
        }
        terms_page, created = TermsPage.objects.get_or_create(
            pk=1, defaults=terms_defaults
        )
        ...
        privacy_defaults = {
            ...
            "body": (
                "<h2>1. Introduction</h2>"
                "<p>At Bwire Global Tech, we are committed to protecting your privacy and ensuring that your "
                "personal information is handled in a safe and responsible manner. By using our website, you consent "
                ...
                "<p>We implement appropriate technical and organizational measures to protect your data, "
                "including secure servers and hosting environments, encryption where applicable, and restricted access "
                "to sensitive data.</p>"
                ...
                "<p>Our website may contain links to external websites. We are not responsible for the privacy "
                "practices or content of those third-party sites.</p>"
                "<h2>9. Children's Privacy</h2>"
                "<p>Our services are not intended for individuals under the age of 18. We do not knowingly collect "
                "personal data from children.</p>"
                "<h2>10. International Data Transfers</h2>"
                "<p>If you access our website from outside Kenya, your data may be transferred and processed in Kenya "
                ...
                "<p>If you have any questions about this Privacy Policy or how your data is handled, contact us:<br>"
                "Bwire Global Tech<br>Email: bwireglobaltech917@gmail.com<br>Phone: 0722206805</p>"
        ...
        privacy_page, created = PrivacyPage.objects.get_or_create(
            pk=1, defaults=privacy_defaults
        )
