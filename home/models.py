...
class HomeCta(models.Model):
    ...
    title = models.CharField(
        max_length=200, default="Send a website brief or an AI idea."
    )
    body = models.TextField(
        default="We will turn it into a real project path, not generic filler."
    )
...
class PricingHero(models.Model):
    ...
    ai_note = models.TextField(
        default="AI solutions: From $700 per project. Custom AI systems are priced by scope."
    )
...
class PricingCta(models.Model):
    eyebrow = models.CharField(
        max_length=120, default="Ready to build something powerful?"
    )
    title = models.CharField(
        max_length=200, default="Start your project or request a quote."
    )
...
class TermsPage(models.Model):
    title = models.CharField(
        max_length=200, default="Terms of Use - Bwire Global Tech (Advanced Version)"
    )
    lede = models.TextField(
...
class PrivacyPage(models.Model):
    title = models.CharField(
        max_length=200, default="Privacy Policy - Bwire Global Tech"
    )
    lede = models.TextField(
        default=(
