...
class HomeServiceAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (
            None,
            {"fields": ("title", "body", "order", "bullet_1", "bullet_2", "bullet_3")},
        ),
    )
...
class HomeTestimonialAdmin(admin.ModelAdmin):
    ...
    ordering = ("order",)
    fieldsets = ((None, {"fields": ("author", "testimonial", "order")}),)
...
class HomeCtaAdmin(admin.ModelAdmin):
    ...
    fieldsets = ((None, {"fields": ("eyebrow", "title", "body", "button_label")}),)
...
class PortfolioItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("label", "category", "title", "body", "featured", "order")}),
        (
            "Bullets",
            {"fields": ("bullet_1", "bullet_2", "bullet_3"), "classes": ("collapse",)},
        ),
        (
            "Details",
            {"fields": ("process", "testimonial", "results"), "classes": ("collapse",)},
        ),
    )
